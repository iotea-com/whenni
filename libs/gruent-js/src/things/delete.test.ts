import deleteThing from './delete'
...
describe('things/delete', () => {
  ...
  it('should return OK', async () => {
    ...
    const result = await deleteThing(
      'tea_fake',
      config,
      mockRequestData.spaceId,
      mockRequestData.thingId,
    )

    // Then
    const expectedUrl = new URL('https://api.gruent.com/v1/things/thing-id-fake')
