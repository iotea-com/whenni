...
func (n *HttpSourceNode) GetInputChans(ctx context.Context) []node.IoChannel {
	return n.inputChannels
}

func (n *HttpSourceNode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *HttpSourceNode) GetOutputChans(ctx context.Context) []node.IoChannel {
	return n.outputChannels
}

func (n *HttpSourceNode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
