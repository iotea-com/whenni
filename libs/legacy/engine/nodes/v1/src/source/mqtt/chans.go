...
func (n *MqttSourceNode) GetInputChans(ctx context.Context) []node.IoChannel {
	return n.inputChannels
}

func (n *MqttSourceNode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *MqttSourceNode) GetOutputChans(ctx context.Context) []node.IoChannel {
	return n.outputChannels
}

func (n *MqttSourceNode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
