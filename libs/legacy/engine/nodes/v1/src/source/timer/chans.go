...
func (n *TimerSourceNode) GetInputChans(ctx context.Context) []node.IoChannel {
	return n.inputChannels
}

func (n *TimerSourceNode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *TimerSourceNode) GetOutputChans(ctx context.Context) []node.IoChannel {
	return n.outputChannels
}

func (n *TimerSourceNode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
