...
func (n *NatsSourceSubnode) GetInputChans(ctx context.Context) []node.IoChannel {
	return n.inputChannels
}

func (n *NatsSourceSubnode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *NatsSourceSubnode) GetOutputChans(ctx context.Context) []node.IoChannel {
	return n.outputChannels
}

func (n *NatsSourceSubnode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
