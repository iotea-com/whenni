...
func (n *KafkaSourceSubnode) GetInputChans(ctx context.Context) []node.IoChannel {
	return n.inputChannels
}

func (n *KafkaSourceSubnode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *KafkaSourceSubnode) GetOutputChans(ctx context.Context) []node.IoChannel {
	return n.outputChannels
}

func (n *KafkaSourceSubnode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
