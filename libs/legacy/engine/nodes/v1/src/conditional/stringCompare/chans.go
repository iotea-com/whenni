...
func (n *StringCompareConditionalNode) GetInputChans(ctx context.Context) []node.IoChannel {
...
func (n *StringCompareConditionalNode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *StringCompareConditionalNode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
...
func (n *StringCompareConditionalNode) GetOutputChans(ctx context.Context) []node.IoChannel {
