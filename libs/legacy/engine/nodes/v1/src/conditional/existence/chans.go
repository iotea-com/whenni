...
func (n *ExistenceConditionalNode) GetInputChans(ctx context.Context) []node.IoChannel {
...
func (n *ExistenceConditionalNode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *ExistenceConditionalNode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
...
func (n *ExistenceConditionalNode) GetOutputChans(ctx context.Context) []node.IoChannel {
