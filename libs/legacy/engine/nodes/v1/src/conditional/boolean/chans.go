...
func (n *BooleanConditionalNode) GetInputChans(ctx context.Context) []node.IoChannel {
...
func (n *BooleanConditionalNode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *BooleanConditionalNode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
...
func (n *BooleanConditionalNode) GetOutputChans(ctx context.Context) []node.IoChannel {
