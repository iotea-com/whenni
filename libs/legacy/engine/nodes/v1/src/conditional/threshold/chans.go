...
func (n *ThresholdConditionalNode) GetInputChans(ctx context.Context) []node.IoChannel {
...
func (n *ThresholdConditionalNode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *ThresholdConditionalNode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
...
func (n *ThresholdConditionalNode) GetOutputChans(ctx context.Context) []node.IoChannel {
