...
func (n *InfluxDBActionNode) GetInputChans(ctx context.Context) []node.IoChannel {
...
func (n *InfluxDBActionNode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *InfluxDBActionNode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
	return nil
}

func (n *InfluxDBActionNode) GetOutputChans(ctx context.Context) []node.IoChannel {
	return nil
}
