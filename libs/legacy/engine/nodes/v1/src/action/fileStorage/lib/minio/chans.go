...
func (n *MinioActionSubnode) GetInputChans(ctx context.Context) []node.IoChannel {
...
func (n *MinioActionSubnode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
// minio action node doesn't have output channel
func (n *MinioActionSubnode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
	return nil
}

func (n *MinioActionSubnode) GetOutputChans(ctx context.Context) []node.IoChannel {
	return nil
}
