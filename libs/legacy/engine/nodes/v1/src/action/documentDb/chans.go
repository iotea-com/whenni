...
func (n *DocumentDbActionNode) GetInputChans(ctx context.Context) []node.IoChannel {
	return n.inputChannels
}

func (n *DocumentDbActionNode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *DocumentDbActionNode) GetOutputChans(ctx context.Context) []node.IoChannel {
	return n.outputChannels
}

func (n *DocumentDbActionNode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
