...
func (n *MongoDbActionSubnode) GetInputChans(ctx context.Context) []node.IoChannel {
	return n.inputChannels
}

func (n *MongoDbActionSubnode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *MongoDbActionSubnode) GetOutputChans(ctx context.Context) []node.IoChannel {
	return n.outputChannels
}

func (n *MongoDbActionSubnode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
