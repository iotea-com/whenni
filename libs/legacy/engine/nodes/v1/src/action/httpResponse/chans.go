...
func (n *HttpResponseActionNode) GetInputChans(ctx context.Context) []node.IoChannel {
	return n.inputChannels
}

func (n *HttpResponseActionNode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *HttpResponseActionNode) GetOutputChans(ctx context.Context) []node.IoChannel {
	return n.outputChannels
}

func (n *HttpResponseActionNode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
