...
func (n *HttpActionNode) GetInputChans(ctx context.Context) []node.IoChannel {
	return n.inputChannels
}

func (n *HttpActionNode) SetInputChan(ctx context.Context, from *node.IoChannel, to *node.IoChannel) error {
...
func (n *HttpActionNode) GetOutputChans(ctx context.Context) []node.IoChannel {
	return n.outputChannels
}

func (n *HttpActionNode) SetOutputChan(ctx context.Context, to *node.IoChannel, from *node.IoChannel) error {
