...
type DevEnvServiceClient interface {
	StopEnvironment(ctx context.Context, in *pb.StopRequest, opts ...grpc.CallOption) (*db.DevEnvironmentModel, error)
}
...
func execute(request *ioteahttp.Request[Input]) (*Output, error) {
	...
	response, err := devenvServiceClient.Stop(request.Context, grpcRequest)
	if err != nil {
	...
	span.AddEvent("successfully stopped environment")
