...
func TestRegister(t *testing.T) {
	t.Run("successfully registers", func(t *testing.T) {
		...
		apitest.AssertRouteExists(t, routes, "GET", "/policies/")
		apitest.AssertRouteExists(t, routes, "GET", "/policies/:certificateId")
		apitest.AssertRouteExists(t, routes, "PUT", "/policies/:certificateId")
	})
}
