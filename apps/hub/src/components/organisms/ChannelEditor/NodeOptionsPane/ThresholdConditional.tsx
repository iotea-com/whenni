...
import { ChannelNode, ThresholdConditionalNodeConfig } from '@iotea/libs/engine/nodes/v1'
import { Condition, Operator } from '@iotea/libs/engine/nodes/v1/src/conditional/threshold'
