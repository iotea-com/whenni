...
import { MqttActionNodeConfig } from '@gruent/libs/engine/nodes/v1/src/action/mqtt'
...
const MqttActionOptions: FC<Props> = ({ things }) => {
  ...
  }, [selectedMqttClient, qos, topic, upsertNode])
...
export default MqttActionOptions
